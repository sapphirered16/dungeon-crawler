...
class Item:
    def __init__(self, name: str, item_type: ItemType, value: int = 0, description: str = "", 
                 ...
                 status_chance: float = 0.0, status_damage: int = 0):
        self.name = name
        ...
        self.status_effects = {}  # For items that can have multiple status effects
    ...
    def from_dict(cls, data: Dict[str, Any]):
        ...
        item.status_effects = data.get("status_effects", {})
        return item