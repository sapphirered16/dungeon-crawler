...
A turn-based dungeon crawler game that runs in the terminal, inspired by nethack. Players explore dungeons, fight enemies, and collect better gear to progress deeper into the dungeon.
